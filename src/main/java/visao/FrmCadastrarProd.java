...
//função para a tabela ser atualizada
    ...
    public void carregaTabela() {
        ...
        ProdutoCadastrarDao dao = new ProdutoCadastrarDao();
    ...
    private void jButtonCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCadastrarActionPerformed
        try {
            ...
            try {
                ...
                ArrayList<CadastrarProduto> produtos = new ProdutoCadastrarDao().getListaProdutos();
            ...
            CadastrarDao categoriaDao = new CadastrarDao();
            for (Cadastrar cat : categoriaDao.getLista()) {
            ...
            ProdutoCadastrarDao produtoDao = new ProdutoCadastrarDao();
